  ...
  return (
    <div className="flex flex-col gap-4 w-[360px]">
      <div className="space-y-0">
        ...
        <p className="text-xs text-muted-foreground">Grant access for website configuration.</p>
      </div>
        ...
        <div className="p-6 h-full overflow-y-scroll flex flex-col gap-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground mt-[2px]">
              Enter a client name and press Enter to add it as a tag. Press Backspace to remove the
              last tag.
            </p>
          </div>
